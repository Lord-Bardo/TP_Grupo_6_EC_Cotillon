    ...
    <div id="loginCard" class="row">
        ...
        <div id="cardRight" class="col-6">
            ...
            <form action="#" method="POST" id="verifyCodeForm">
                ...
                <button type="submit" id="boton" class="btn btn-dark btn-block mt-4">Verificar Código</button>

                <!-- Enlace a Login -->
                <div class="mt-3 text-center">
                    <p class="text-dark">¿No recibiste el código? <a href="#" class="text-info">Reenvía el código</a></p>
                </div>
            </form>
        </div>
    </div>
